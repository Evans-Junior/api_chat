...
<body>
    ...
    <a class="find" href="producer.php">Find Producers' Chats</a>
    </div>
    <div class="container">
        ...
        <form id="message-form" onsubmit="submitForm(event)">
            ...
            <input type="hidden" name="sender" value="Farmer">
            <input type="hidden" name="receiver" value="Producer">
            <input type="hidden" name="sentby" value="Farmer">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, message) {
                    ...
                    var messageClass = (message.sender_name === 'Producer') ?  'sender-message' : 'receiver-message' ;
